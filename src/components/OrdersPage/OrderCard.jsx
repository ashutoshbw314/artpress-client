...
function OrderCard({order}) {
  ...
  return (
    <div className='p-4 my-5 border-4 border-white rounded-lg shadow-md lg:p-2 grid grid-cols-1 lg:grid-cols-4 hover:scale-105 hover:border-indigo-400 transform transition-all'>
