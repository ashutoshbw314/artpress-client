    ...
    <div className=''>
      <header className='flex flex-wrap items-center px-6 bg-white bg-opacity-80 lg:px-6 lg:py-0'>
        <div className='flex items-center justify-center flex-1 my-2 lg:my-0 lg:justify-start'>
          ...
          <h2 className='ml-3 font-bold'>Let's Ride</h2>
        </div>
        ...
        <div className={`${verticalMenu ? '' : 'hidden '} w-full lg:flex lg:items-center lg:w-auto`}>
          <nav>
            <ul className='items-center justify-between text-base text-gray-800 lg:flex lg:pt-0'>
              ...
              <li><Link className='block px-0 py-3 border-b-2 border-transparent lg:border-b-4 lg:px-4 lg:py-2 hover:border-pink-600' to='/admin'>Admin</Link></li>
